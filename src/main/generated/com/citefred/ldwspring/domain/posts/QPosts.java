...
public class QPosts extends EntityPathBase<Posts> {
    ...
    private static final long serialVersionUID = 1673702287L;
    ...
    public final com.citefred.ldwspring.domain.user.QUser author;
    ...
    public QPosts(Class<? extends Posts> type, PathMetadata metadata, PathInits inits) {
        ...
        this.author = inits.isInitialized("author") ? new com.citefred.ldwspring.domain.user.QUser(forProperty("author")) : null;
    }
